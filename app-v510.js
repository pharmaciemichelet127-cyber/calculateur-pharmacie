...
// Format attendu : colonnes EAN, LABO, MARCHE, SOUS_MARCHE (+ LIBELLE optionnel)
  ...
  input.onchange = function (e) {
    ...
    reader.onload = function (ev) {
      try {
        ...
        var iEAN  = hdrs.indexOf('EAN');
        var iLABO = hdrs.indexOf('LABO');
        var iMAR  = hdrs.indexOf('MARCHE');
        var iSM   = hdrs.indexOf('SOUS_MARCHE');
        ...
        meqInited = false; meqInit(); meqRender();
        alert('✅ MAP_PRODUIT_MARCHE importé\n• ' + nb + ' EANs mappés\n• Feuille : ' + sheetName +
              (Object.keys(condVentesOspharm).length ? '\n\n→ Marchés recalculés avec ventes existantes.' : '\n\n→ Importez maintenant les ventes LGPI pour calculer les volumes.'));
