...
async function catImporterXLSX(input) {
  ...
  try {
    ...
    if (idxTarif < 0) idxTarif = headerUp.findIndex(function(c){ return (c.indexOf('TARIF') >= 0 || c.indexOf('P.P.H.T') >= 0 || (c.indexOf('PRIX') >= 0 && c.indexOf('HT') >= 0)) && c.indexOf('PPC') < 0 && c.indexOf('TTC') < 0; });
