...
function condClasserThuasneGammesAnatomiques() {
  ...
  (labo.produits || []).forEach(function(p) {
    ...
    else if (n.indexOf('CHAU.') >= 0) gamme = 'Compression - Chaussettes';
    else if (n.indexOf('COLLANT') >= 0) gamme = 'Compression - Collants';
    else if (n.indexOf('B.CUISSE') >= 0 || n.indexOf('MI-BAS') >= 0) gamme = 'Compression - Bas';
    else if (n.indexOf('VENOFLEX') >= 0 || n.indexOf('CLINIC') >= 0 || n.indexOf('BIFLEX') >= 0) gamme = 'Compression - Autre';
    else if (/\bCL[123]\b/.test(n)) gamme = 'Compression - Autre'; // classe de compression mentionnee mais type (chaussette/collant/bas) indetermine par le nom
    else if (fam === 'Bas') gamme = 'Compression - Bas';
