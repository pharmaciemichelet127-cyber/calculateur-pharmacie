// Calculateur Pharmacie Michelet — app.js v3.88
        ...
        var resp = await fetch('https://api.anthropic.com/v1/messages', {
          ...
          body: JSON.stringify({
            ...
            messages: [{role:'user', content:
              ...
              var marchesStr = marchesDef.length > 0
                ? 'Marches negocie disponibles (utilise EXACTEMENT ces labels pour marche, ou vide si aucun ne correspond): ' + marchesDef.map(function(m){ return m.label||''; }).join(', ')
                : 'marche (gamme produit ex: PHOTODERM, CICALFATE, CLEANANCE, XERACALM, HYDRANCE...)';
              return 'Classifie ces produits pharmaceutiques/dermo-cosmetiques. Pour chacun: cat (Soin corps, Soin visage, Solaire, Capillaire, Complement alimentaire, Hygiene...), scat (sous-categorie courte), marche (' + marchesStr + '). JSON UNIQUEMENT: {"produits":[{"idx":1,"cat":"...","scat":"...","marche":"..."}]}\n\n' + noms;
            })()
            }]
          })
        });
