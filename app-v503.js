...
function condClasserThuasneGammesAnatomiques() {
  ...
  (labo.produits || []).forEach(function(p) {
    ...
    else if (fam) gamme = fam; // repli 1 : Famille fournisseur (Lingerie/Maillots, Prothèses mamaires, Lymphologie, Vêtements de compression, Bandes, HomeCare Light, Home Care, Autres...)
    else if (marque) gamme = marque; // repli 2 : Marque/catégorie fournisseur (ex: DONJOY, VEINAX chez Enovis)
