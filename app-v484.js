...
function decAfficherResume(labo) {
  ...
  html += '<div style="font-size:10px;color:#c01c28;background:#fff3f0;padding:3px 6px;border-radius:4px;margin:4px 0">DEBUG : laboObj=' + (laboObj ? ('"' + laboObj.nom + '" (id ' + Object.keys(condLabos).find(function(k){return condLabos[k]===laboObj;}) + ')') : 'NON TROUVÉ') + ' · produits=' + (laboObj && laboObj.produits ? laboObj.produits.length : 'n/a') + ' · catalogueEans=' + (catalogueEans ? Object.keys(catalogueEans).length : 'null') + '</div>';
