...
function meqRenderVueLabo() {
  ...
  // ── Score de priorité : volume N desc, puis CA N desc, bonus évolution positive ──
  lignes.sort(function(a, b) {
    // Score = volume × (1 + bonus évolution)
    var bonusA = (a.evo !== null && a.evo > 0) ? 1 + a.evo / 100 : 1;
    var bonusB = (b.evo !== null && b.evo > 0) ? 1 + b.evo / 100 : 1;
  ...
  content.innerHTML =
    ...
    '</tr></tfoot>' +
    '</table>' +
    '<p style="font-size:10px;color:var(--text-ter);margin-top:8px">⚡ = rang ≥ 3 avec PDM &lt; 20% dans un marché &gt; 50 unités → potentiel de gain</p>' +
    '</div>';
}
