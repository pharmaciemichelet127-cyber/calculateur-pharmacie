...
function condClasserThuasneGammesAnatomiques() {
  ...
  (labo.produits || []).forEach(function(p) {
    ...
    else if (n.indexOf('VENOFLEX') >= 0 || n.indexOf('CLINIC') >= 0 || n.indexOf('BIFLEX') >= 0) gamme = 'Compression';
    ...
    else if (n.indexOf('CHAU.') >= 0 || n.indexOf('COLLANT') >= 0 || n.indexOf('B.CUISSE') >= 0 || n.indexOf('MI-BAS') >= 0 || /\bCL[123]\b/.test(n)) gamme = 'Compression';
    else if (fam === 'Bas') gamme = 'Compression';
