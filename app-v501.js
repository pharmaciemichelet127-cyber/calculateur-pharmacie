...
function simLPPRGammeProduits() {
  ...
  var diag = [];
  var defs = [
    { motCle: 'THUASNE', filtreLabel: 'Gamme labo = "Compression"', filtre: function(p){ return p.famille === 'Compression'; } },
...
function simLPPRRender() {
  ...
  if (lignes.length === 0) {
    resEl.innerHTML = diagHTML + '<p style="font-size:12px;color:var(--text-ter)">Aucun produit trouvé sur ce périmètre. Vérifie que Thuasne/Podowell/Gibaud/Enovis existent, que les Gamme labo (Compression, CHUT, CHUP) sont classées, et que le LPPR est renseigné.</p>';
