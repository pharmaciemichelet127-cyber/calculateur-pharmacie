...
function cmdGenererAvecAz() {
  ...
  // Récupérer les lignes générées par cmdGenerer (stockées dans cmdDerniereSimulation.lignes)
  var lignesCalc = (cmdDerniereSimulation && cmdDerniereSimulation.lignes) || [];
  var calcByEan = {};
