...
function condAutoClasserThuasneCompression() {
  ...
  (labo.produits || []).forEach(function(p) {
    ...
    var estCompression = cat.indexOf('compression') >= 0 || nom.indexOf('venoflex') >= 0 || nom.indexOf('biflex') >= 0 || nom.indexOf('compression') >= 0;
    if (!estCompression) { nbIgnores++; return; }
    var estVenoflexOC = nom.indexOf('venoflex') >= 0 && (nom.indexOf('original') >= 0 || nom.indexOf('clinic') >= 0);
    if (estVenoflexOC) {
