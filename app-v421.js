...
function decRenderConditionsCommerciales(labo) {
  ...
  if (marches.length > 0) {
    ...
    if (prodsLabo.length > 0) {
      ...
      if (hasN1Loc) { html += '<th style="' + thS2 + '">Qté N-1</th><th style="' + thS2 + '">Qté N</th>'; }
