...
function showTab(t) {
  var WIDE = ['cat','sim','cmd','prixnet','decision','cycle'];
  var mainEl = document.querySelector('.main');
  ['neg','prix','lex','pm','bundle','strat','verdict','mc','cond','guide','prixnet','cmd','cat','sim','workflow','decision','cycle'].forEach(function(x) {
