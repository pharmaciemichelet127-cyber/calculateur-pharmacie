...
function catRenderTable() {
  ...
  // Pagination : on ne regroupe/affiche que la tranche de la page courante, pas tout le catalogue
  // d'un coup (un Thuasne à 5600+ refs gèlerait le navigateur en rendu complet).
  var totalProduits = catProduits.length;
