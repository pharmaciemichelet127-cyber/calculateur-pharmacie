...
function catRenderTable() {
  ...
  sortedKeys.forEach(function(marcheId) {
    ...
    html += '<tr style="background:' + hdrBg + '"><td colspan="' + (showLPPR ? 10 : 9) + '" style="padding:5px 10px;font-size:10px;font-weight:700;color:' + hdrClr + ';text-transform:uppercase;letter-spacing:.06em">' +
